...
export function matchesTicketSearch(ticket, query) {
  ...
  const haystack = [
    ...
    ticket.initialActionTaken,
    ticket.initialActionType,
    ticket.initialCustomerContactStatus,
    ticket.initialCustomerSatisfied,
    ticket.initialResolutionDetails,
    ticket.description,
    raw.ticket_no,
    raw.branch_name,
    raw.customer_name,
    ...
    raw.initial_action_type,
    raw.initial_customer_contact_status,
    raw.initial_customer_satisfied,
    raw.initial_resolution_details,
    raw.description,
...
export function normalizeTicket(row, repliesByTicketId, attachmentsByTicketId, language, branchCityByName = {}) {
  ...
  return {
    ...
    description,
    initialActionTaken: row.initial_action_taken || "No",
    initialActionType: row.initial_action_type || "",
    initialCustomerContactStatus: row.initial_customer_contact_status || "",
    initialCustomerSatisfied: row.initial_customer_satisfied || "",
    initialResolutionDetails: row.initial_resolution_details || "",
    initialActionRecordedAt: row.initial_action_recorded_at ? new Date(row.initial_action_recorded_at).getTime() : null,
